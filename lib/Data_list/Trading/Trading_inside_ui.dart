...
import 'package:freerun/Data_list/Trading/Trading_inside_data.dart';
...
class TradingInsideui extends StatelessWidget {
  final int index;
  const TradingInsideui({Key? key, required this.index}) : super(key: key);
      ...
      child: Scaffold(
        ...
        appBar:   AppBar(
          ...
          title: Row(
              ...
              children:<Widget>[
                Text(TradingInside[index].Companyname,
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image:DecorationImage(
                          ...
                          image: AssetImage(TradingInside[index].Image1),
                                  ...
                                  return Row(
                                    children : [
                                      Padding(
                                        ...
                                        child: ClipRect(
                                          child: Text(TradingInside[index].ReferalCode, style: TextStyle(
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () async {
                                          await FlutterClipboard.copy(TradingInside[index].ReferalCode);
                                ...
                                builder: (context) {
                                  return Row(
                                    children: [
                                      ...
                                      Center(
                                        child: Link(
                                          uri: Uri.parse(TradingInside[index].ReferalLink),
                                          ...
                                          builder: (context, followLink) =>
                                              ElevatedButton(
                                                ...
                                                child: Text(
                                                    TradingInside[index].ReferalLink,
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () async {
                                          await FlutterClipboard.copy(TradingInside[index].ReferalLink);
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: ClipRect(
                          child: Text(TradingInside[index].BenifitInformation, style: TextStyle(
                              color: Colors.tealAccent, fontSize: 14, decoration: TextDecoration.none)),
                        ),
                      ),
                    ),
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            ...
                            child: ClipRect(
                              child: Text(TradingInside[index].ProcessInformation, style: TextStyle(
                                  color: Colors.tealAccent, fontSize: 14, decoration: TextDecoration.none)),
                            ),
                          ...
                          Center(
                              ...
                              child: Link(
                                uri: Uri.parse(TradingInside[index].GoogleForm
                                ),
                                // target: LinkTarget.blank,
                                builder: (context, followLink) =>
                                    Padding(
                                      ...
                                      child: ElevatedButton(
                                        ...
                                        child: Text(
                                            TradingInside[index].GoogleForm,
                                            style: TextStyle(fontSize: 12
                                            )),
                                      ),
                                    ),
                  ...
                  Center(
                      ...
                      child: Link(
                        uri: Uri.parse(TradingInside[index].videolink),
                        // target: LinkTarget.blank,
                        builder: (context, followLink) =>
                            ElevatedButton(
